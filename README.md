...
Some scripts and small programs that are packaged into clandro's
clandro-tools package.

## Mirrors

The mirrors/ directory contains files with information about all the clandro mirrors, group by different parts of the world. To add a new mirror, open a pull request to add a new file in the appropriate directory.

The file should be named after the base url of the repository, for example packages.clandro.dev, and the content as follows:
...
WEIGHT=1
MAIN="<url to clandro-main repo>"
ROOT="<url to clandro-root repo>"
X11="<url to clandro-x11 repo>"
```
...
WEIGHT=1
MAIN="https://mirror.accum.se/mirror/clandro.dev/clandro-main"
ROOT="https://mirror.accum.se/mirror/clandro.dev/clandro-root"
X11="https://mirror.accum.se/mirror/clandro.dev/clandro-x11"
```
