...
generate-mirror-table() {
	...
	printf "|:-------------------------------------------------------|:%-${len}s-|\n" | tr ' ' '-'
	printf "| [Main](https://github.com/clandro/clandro-packages)      | %-${len}s |\n" "$main_entry"
	printf "| [Root](https://github.com/clandro/clandro-root-packages) | %-${len}s |\n" "$root_entry"
	printf "| [X11](https://github.com/clandro/x11-packages)          | %-${len}s |\n" "$x11_entry"
}
